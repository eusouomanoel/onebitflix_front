            ...
            <Container className="py-5">
                ...
                <Form className={styles.form} onSubmit={handleLogin}>
                    ...
                    <FormGroup>
                        ...
                        <Input id="email" name="email" type="email" placeholder="Qual o seu email?" required maxLength={30} className={styles.input} />
                    </FormGroup>
                    <FormGroup>
                        <Label for="password" className={styles.label}>SENHA:</Label>
                        <Input id="password" name="password" type="password" placeholder="Qual a sua senha?" required maxLength={20} minLength={6} className={styles.input} />
                    </FormGroup>
